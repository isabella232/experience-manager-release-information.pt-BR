...
description: Notas de versão do Cumulative Fix Pack do Experience Manager 6.2. Saiba mais sobre os problemas corrigidos em vários pacotes de correção cumulativos nos componentes do Experience Manager.
